namespace Melidya_Reloaded.DAL
{
    using System;
    ...
    public partial class Melidya_ReloadedDbContext : DbContext
    {
        public Melidya_ReloadedDbContext()
            : base("name=Melidya_ReloadedDataModel")
        {
        }
